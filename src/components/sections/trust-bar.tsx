...
// and the strip now leads with the Veteran Owned Small Business / military proof
// instead. Passing an unconfirmed 2023 in "just in case" is how a false founding
// claim ships the day someone edits the message back to "Serving since {year}".
